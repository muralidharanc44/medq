...
export declare class UserService {
    ...
    constructor(userInterface: Model<UserInterface>, addressInterface: Model<AddressInterface>, client: TwilioClient);
    ...
    userUpdate(body: any, user_id: any): Promise<{
        ok: number;
        n: number;
        nModified: number;
    }>;
    ...
    deshboardProduct(body: any): Promise<{
        responseCode: number;
        error: boolean;
        responseMessage: string;
        data: {
    ...
    addAddress(header: any, body: any): Promise<{
        responseCode: number;
        error: boolean;
        responseMessage: string;
